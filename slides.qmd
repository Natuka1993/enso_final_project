...
::: {.incremental}
- ENSO is the dominant mode of interannual climate variability and plays a central role in global climate dynamics
- Studying ENSO requires analyzing variability in ocean temperature fields
- CESM provides detailed ocean model output, but the data are large, cloud-hosted, and not immediately analysis-ready
...
- ENSO signal becomes clearer when focusing on this region
...
- Provides a foundation for analyzing ENSO variability in climate models
:::